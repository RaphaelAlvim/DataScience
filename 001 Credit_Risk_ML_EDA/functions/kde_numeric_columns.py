...
def kde_numeric_columns(df, exclude_columns=None):
    """
    Função para criar gráficos (KDE) das colunas numéricas de um DataFrame.
    ...
    # Loop para criar cada KDE plot
    for i, column in enumerate(numerical_columns):
        sns.kdeplot(x=column, data=df, ax=axes[i], shade=True)
